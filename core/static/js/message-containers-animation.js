document.addEventListener("DOMContentLoaded", function () {
  ...
  // Устанавливаем начальное состояние для ссылки "Вернуться в профиль"
  gsap.set(backProfileLink, { opacity: 0, y: '50%' });

  // Анимация плавного появления ссылки "Вернуться в профиль"
  gsap.to(backProfileLink, { opacity: 1, y: '0%', duration: 1, ease: 'power1.inOut', delay: 0.5 });

  // Анимация для блоков inboxMessage и composeMessage (как в вашем примере)
