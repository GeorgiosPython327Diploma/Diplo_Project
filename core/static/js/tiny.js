document.addEventListener("DOMContentLoaded", function() {
  tinymce.init({
    ...
    height: 200,
    width: 800,
    plugins: 'autolink lists link image charmap print preview anchor searchreplace visualblocks code fullscreen insertdatetime media table contextmenu paste code emoticons',
